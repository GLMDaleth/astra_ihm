...
const SENSOR_TOPICS = [
  ...
  { topic: "/sensor/camera_frontend/state", label: "CAM FRONT" },
  { topic: "/sensor/camera_backend/state", label: "CAM BACK" },
...
function ExamplePanel({ context }: { context: PanelExtensionContext }): ReactElement {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "row", flexWrap: "wrap", padding: "0.5rem" }}>
