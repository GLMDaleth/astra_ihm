...
#define NODE_MAIN_LOGGER_NAME "mqtt_client"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libmqtt_client_lib.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<mqtt_client::MqttClient>";
