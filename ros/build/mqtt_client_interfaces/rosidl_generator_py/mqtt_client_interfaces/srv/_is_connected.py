...
class IsConnected_Event(metaclass=Metaclass_IsConnected_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<mqtt_client_interfaces/IsConnected_Request, 1>',
        'response': 'sequence<mqtt_client_interfaces/IsConnected_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['mqtt_client_interfaces', 'srv'], 'IsConnected_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['mqtt_client_interfaces', 'srv'], 'IsConnected_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from mqtt_client_interfaces.srv import IsConnected_Request
    ...
    def response(self, value):
        if self._check_fields:
            from mqtt_client_interfaces.srv import IsConnected_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class IsConnected(metaclass=Metaclass_IsConnected):
    ...
    from mqtt_client_interfaces.srv._is_connected import IsConnected_Event as Event
