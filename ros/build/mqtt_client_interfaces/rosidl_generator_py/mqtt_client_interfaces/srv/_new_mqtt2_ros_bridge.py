...
class Metaclass_NewMqtt2RosBridge_Event(type):
    """Metaclass of message 'NewMqtt2RosBridge_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__new_mqtt2_ros_bridge__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__new_mqtt2_ros_bridge__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__new_mqtt2_ros_bridge__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__new_mqtt2_ros_bridge__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__new_mqtt2_ros_bridge__event
...
class NewMqtt2RosBridge_Event(metaclass=Metaclass_NewMqtt2RosBridge_Event):
    """Message class 'NewMqtt2RosBridge_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<mqtt_client_interfaces/NewMqtt2RosBridge_Request, 1>',
        'response': 'sequence<mqtt_client_interfaces/NewMqtt2RosBridge_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['mqtt_client_interfaces', 'srv'], 'NewMqtt2RosBridge_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['mqtt_client_interfaces', 'srv'], 'NewMqtt2RosBridge_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from mqtt_client_interfaces.srv import NewMqtt2RosBridge_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, NewMqtt2RosBridge_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'NewMqtt2RosBridge_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from mqtt_client_interfaces.srv import NewMqtt2RosBridge_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, NewMqtt2RosBridge_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'NewMqtt2RosBridge_Response'"
...
class Metaclass_NewMqtt2RosBridge(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _new_mqtt2_ros_bridge.Metaclass_NewMqtt2RosBridge_Event._TYPE_SUPPORT is None:
                _new_mqtt2_ros_bridge.Metaclass_NewMqtt2RosBridge_Event.__import_type_support__()
...
class NewMqtt2RosBridge(metaclass=Metaclass_NewMqtt2RosBridge):
    ...
    from mqtt_client_interfaces.srv._new_mqtt2_ros_bridge import NewMqtt2RosBridge_Event as Event
