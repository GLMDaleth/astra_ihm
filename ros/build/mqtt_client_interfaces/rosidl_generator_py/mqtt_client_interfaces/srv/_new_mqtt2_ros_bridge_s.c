...
ROSIDL_GENERATOR_C_EXPORT
bool mqtt_client_interfaces__srv__new_mqtt2_ros_bridge__event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mqtt_client_interfaces.srv._new_mqtt2_ros_bridge.NewMqtt2RosBridge_Event", full_classname_dest, 72) == 0);
  }
  mqtt_client_interfaces__srv__NewMqtt2RosBridge_Event * ros_message = _ros_message;
  {  // info
  ...
  {  // request
    ...
    if (!mqtt_client_interfaces__srv__NewMqtt2RosBridge_Request__Sequence__init(&(ros_message->request), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create mqtt_client_interfaces__srv__NewMqtt2RosBridge_Request__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    mqtt_client_interfaces__srv__NewMqtt2RosBridge_Request * dest = ros_message->request.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!mqtt_client_interfaces__srv__new_mqtt2_ros_bridge__request__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
  ...
  {  // response
    ...
    if (!mqtt_client_interfaces__srv__NewMqtt2RosBridge_Response__Sequence__init(&(ros_message->response), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create mqtt_client_interfaces__srv__NewMqtt2RosBridge_Response__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    mqtt_client_interfaces__srv__NewMqtt2RosBridge_Response * dest = ros_message->response.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!mqtt_client_interfaces__srv__new_mqtt2_ros_bridge__response__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of NewMqtt2RosBridge_Event */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mqtt_client_interfaces.srv._new_mqtt2_ros_bridge");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "NewMqtt2RosBridge_Event");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
  ...
  {  // request
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = mqtt_client_interfaces__srv__new_mqtt2_ros_bridge__request__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
  ...
  {  // response
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = mqtt_client_interfaces__srv__new_mqtt2_ros_bridge__response__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
