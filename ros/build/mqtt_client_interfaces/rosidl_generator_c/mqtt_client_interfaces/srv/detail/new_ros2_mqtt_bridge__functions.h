...
#ifndef MQTT_CLIENT_INTERFACES__SRV__DETAIL__NEW_ROS2_MQTT_BRIDGE__FUNCTIONS_H_
#define MQTT_CLIENT_INTERFACES__SRV__DETAIL__NEW_ROS2_MQTT_BRIDGE__FUNCTIONS_H_
...
/// Initialize srv/NewRos2MqttBridge message.
/**
...
/// Finalize srv/NewRos2MqttBridge message.
/**
...
/// Create srv/NewRos2MqttBridge message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * mqtt_client_interfaces__srv__NewRos2MqttBridge_Request__init().
...
/// Destroy srv/NewRos2MqttBridge message.
/**
 * It calls
 * mqtt_client_interfaces__srv__NewRos2MqttBridge_Request__fini()
...
/// Check for srv/NewRos2MqttBridge message equality.
/**
...
/// Copy a srv/NewRos2MqttBridge message.
/**
...
/// Initialize array of srv/NewRos2MqttBridge messages.
/**
...
/// Finalize array of srv/NewRos2MqttBridge messages.
/**
 * It calls
 * mqtt_client_interfaces__srv__NewRos2MqttBridge_Request__fini()
...
/// Create array of srv/NewRos2MqttBridge messages.
/**
 * It allocates the memory for the array and calls
 * mqtt_client_interfaces__srv__NewRos2MqttBridge_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/NewRos2MqttBridge messages.
/**
 * It calls
 * mqtt_client_interfaces__srv__NewRos2MqttBridge_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/NewRos2MqttBridge message array equality.
/**
...
/// Copy an array of srv/NewRos2MqttBridge messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * mqtt_client_interfaces__srv__NewRos2MqttBridge_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mqtt_client_interfaces
...
/**
 * It calls
 * mqtt_client_interfaces__srv__NewRos2MqttBridge_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_mqtt_client_interfaces
...
/**
 * It allocates the memory for the array and calls
 * mqtt_client_interfaces__srv__NewRos2MqttBridge_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mqtt_client_interfaces
...
/**
 * It calls
 * mqtt_client_interfaces__srv__NewRos2MqttBridge_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * mqtt_client_interfaces__srv__NewRos2MqttBridge_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mqtt_client_interfaces
...
/**
 * It calls
 * mqtt_client_interfaces__srv__NewRos2MqttBridge_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_mqtt_client_interfaces
...
/**
 * It allocates the memory for the array and calls
 * mqtt_client_interfaces__srv__NewRos2MqttBridge_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mqtt_client_interfaces
...
/**
 * It calls
 * mqtt_client_interfaces__srv__NewRos2MqttBridge_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MQTT_CLIENT_INTERFACES__SRV__DETAIL__NEW_ROS2_MQTT_BRIDGE__FUNCTIONS_H_
