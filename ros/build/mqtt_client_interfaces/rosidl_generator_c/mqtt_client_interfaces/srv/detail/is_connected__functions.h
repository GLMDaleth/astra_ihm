...
#ifndef MQTT_CLIENT_INTERFACES__SRV__DETAIL__IS_CONNECTED__FUNCTIONS_H_
#define MQTT_CLIENT_INTERFACES__SRV__DETAIL__IS_CONNECTED__FUNCTIONS_H_
 ...
 * calls
 * mqtt_client_interfaces__srv__IsConnected_Request__init().
...
/**
 * It calls
 * mqtt_client_interfaces__srv__IsConnected_Request__fini()
 ...
 * mqtt_client_interfaces__srv__IsConnected_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * mqtt_client_interfaces__srv__IsConnected_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * mqtt_client_interfaces__srv__IsConnected_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mqtt_client_interfaces
...
/**
 * It calls
 * mqtt_client_interfaces__srv__IsConnected_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_mqtt_client_interfaces
...
/**
 * It allocates the memory for the array and calls
 * mqtt_client_interfaces__srv__IsConnected_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mqtt_client_interfaces
...
/**
 * It calls
 * mqtt_client_interfaces__srv__IsConnected_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * mqtt_client_interfaces__srv__IsConnected_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mqtt_client_interfaces
...
/**
 * It calls
 * mqtt_client_interfaces__srv__IsConnected_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_mqtt_client_interfaces
...
/**
 * It allocates the memory for the array and calls
 * mqtt_client_interfaces__srv__IsConnected_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_mqtt_client_interfaces
...
/**
 * It calls
 * mqtt_client_interfaces__srv__IsConnected_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MQTT_CLIENT_INTERFACES__SRV__DETAIL__IS_CONNECTED__FUNCTIONS_H_
