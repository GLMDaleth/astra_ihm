...
enum
{
  mqtt_client_interfaces__srv__NewMqtt2RosBridge_Event__request__MAX_SIZE = 1
};
// response
enum
{
  mqtt_client_interfaces__srv__NewMqtt2RosBridge_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/NewMqtt2RosBridge in the package mqtt_client_interfaces.
typedef struct mqtt_client_interfaces__srv__NewMqtt2RosBridge_Event
{
  service_msgs__msg__ServiceEventInfo info;
  mqtt_client_interfaces__srv__NewMqtt2RosBridge_Request__Sequence request;
  mqtt_client_interfaces__srv__NewMqtt2RosBridge_Response__Sequence response;
} mqtt_client_interfaces__srv__NewMqtt2RosBridge_Event;

// Struct for a sequence of mqtt_client_interfaces__srv__NewMqtt2RosBridge_Event.
typedef struct mqtt_client_interfaces__srv__NewMqtt2RosBridge_Event__Sequence
{
