...
static const _IsConnected_Event_type_support_symbol_names_t _IsConnected_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mqtt_client_interfaces, srv, IsConnected_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mqtt_client_interfaces, srv, IsConnected_Event)),
  }
};
...
{
  return &::mqtt_client_interfaces::srv::rosidl_typesupport_cpp::IsConnected_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, mqtt_client_interfaces, srv, IsConnected_Event)() {
  return get_message_type_support_handle<mqtt_client_interfaces::srv::IsConnected_Event>();
}
...
static const rosidl_service_type_support_t IsConnected_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<mqtt_client_interfaces::srv::IsConnected_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<mqtt_client_interfaces::srv::IsConnected_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<mqtt_client_interfaces::srv::IsConnected_Event>(),
