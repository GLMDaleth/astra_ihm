...
static const _RosMsgType_type_support_symbol_names_t _RosMsgType_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mqtt_client_interfaces, msg, RosMsgType)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mqtt_client_interfaces, msg, RosMsgType)),
  }
};
...
{
  return &::mqtt_client_interfaces::msg::rosidl_typesupport_cpp::RosMsgType_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, mqtt_client_interfaces, msg, RosMsgType)() {
  return get_message_type_support_handle<mqtt_client_interfaces::msg::RosMsgType>();
}
