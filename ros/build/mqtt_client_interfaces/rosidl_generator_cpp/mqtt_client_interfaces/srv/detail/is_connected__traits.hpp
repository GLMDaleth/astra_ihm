...
[[deprecated("use mqtt_client_interfaces::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const mqtt_client_interfaces::srv::IsConnected_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  mqtt_client_interfaces::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use mqtt_client_interfaces::srv::to_yaml() instead")]]
inline std::string to_yaml(const mqtt_client_interfaces::srv::IsConnected_Event & msg)
{
  return mqtt_client_interfaces::srv::to_yaml(msg);
}

template<>
inline const char * data_type<mqtt_client_interfaces::srv::IsConnected_Event>()
{
  return "mqtt_client_interfaces::srv::IsConnected_Event";
}

template<>
inline const char * name<mqtt_client_interfaces::srv::IsConnected_Event>()
{
  return "mqtt_client_interfaces/srv/IsConnected_Event";
}

template<>
struct has_fixed_size<mqtt_client_interfaces::srv::IsConnected_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<mqtt_client_interfaces::srv::IsConnected_Event>
  : std::integral_constant<bool, has_bounded_size<mqtt_client_interfaces::srv::IsConnected_Request>::value && has_bounded_size<mqtt_client_interfaces::srv::IsConnected_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<mqtt_client_interfaces::srv::IsConnected_Event>
  : std::true_type {};
