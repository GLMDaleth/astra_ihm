...
static const _NewMqtt2RosBridge_Request_type_support_symbol_names_t _NewMqtt2RosBridge_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mqtt_client_interfaces, srv, NewMqtt2RosBridge_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mqtt_client_interfaces, srv, NewMqtt2RosBridge_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mqtt_client_interfaces, srv, NewMqtt2RosBridge_Request)() {
  return &::mqtt_client_interfaces::srv::rosidl_typesupport_c::NewMqtt2RosBridge_Request_message_type_support_handle;
}
...
static const _NewMqtt2RosBridge_Response_type_support_symbol_names_t _NewMqtt2RosBridge_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mqtt_client_interfaces, srv, NewMqtt2RosBridge_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mqtt_client_interfaces, srv, NewMqtt2RosBridge_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mqtt_client_interfaces, srv, NewMqtt2RosBridge_Response)() {
  return &::mqtt_client_interfaces::srv::rosidl_typesupport_c::NewMqtt2RosBridge_Response_message_type_support_handle;
}
...
static const _NewMqtt2RosBridge_Event_type_support_symbol_names_t _NewMqtt2RosBridge_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mqtt_client_interfaces, srv, NewMqtt2RosBridge_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mqtt_client_interfaces, srv, NewMqtt2RosBridge_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mqtt_client_interfaces, srv, NewMqtt2RosBridge_Event)() {
  return &::mqtt_client_interfaces::srv::rosidl_typesupport_c::NewMqtt2RosBridge_Event_message_type_support_handle;
}
...
static const _NewMqtt2RosBridge_type_support_symbol_names_t _NewMqtt2RosBridge_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mqtt_client_interfaces, srv, NewMqtt2RosBridge)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mqtt_client_interfaces, srv, NewMqtt2RosBridge)),
  }
};
...
static const rosidl_service_type_support_t NewMqtt2RosBridge_service_type_support_handle = {
  ...
  &NewMqtt2RosBridge_Request_message_type_support_handle,
  &NewMqtt2RosBridge_Response_message_type_support_handle,
  &NewMqtt2RosBridge_Event_message_type_support_handle,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, mqtt_client_interfaces, srv, NewMqtt2RosBridge)() {
  return &::mqtt_client_interfaces::srv::rosidl_typesupport_c::NewMqtt2RosBridge_service_type_support_handle;
}
